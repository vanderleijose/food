...
<body>
  ...
  <script src="<?php echo site_url('admin/vendors/datatables.net/jquery.dataTables.js'); ?>vendors/datatables.net/jquery.dataTables.js"></script>
  ...
  <script src="<?php echo site_url('admin/js/dashboard.js'); ?>js/dashboard.js"></script>
